...
namespace Tests
{
    ...
    public class TestConnection
    {
        ...
        {
            yield return GameClientHelper.AssertConnect(gameClient1a);
            Debug.Log("Leave Room if has room");
            ...
            Debug.Log("1a connect");
            yield return GameClientHelper.AssertConnect(gameClient1a);
            Debug.Log("Check Has Room");
        ...
        public IEnumerator TestJoinRoomAndChat()
        {
            ...
            Debug.Log("Client 3a Invalid Join Room");
