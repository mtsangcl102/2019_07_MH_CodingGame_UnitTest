...
namespace Tests
{
    ...
    public class TestConnection
    {
        ...
        public GameClient gameClient0a = new GameClient(Host, "77abc");
        public GameClient gameClient1a = new GameClient(Host, "771");
        public GameClient gameClient1b = new GameClient(Host, "771");
        public GameClient gameClient2a = new GameClient(Host, "772");
        public GameClient gameClient3a = new GameClient(Host, "773");
