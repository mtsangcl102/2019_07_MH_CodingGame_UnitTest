...
public class xLuaTest : MonoBehaviour {
    ...
    public void TestEncryptionScript()
    {
        ...
        #region YourScript
        //TODO: loader here 
        TextAsset file = Resources.Load<TextAsset>( "Encrypted.lua" );
        string msg = Encoding.UTF8.GetString( _encryptionHelper.Decrypt( Convert.FromBase64String( file.ToString() ), 102 ) );

        _luaEnv.DoString( msg );
