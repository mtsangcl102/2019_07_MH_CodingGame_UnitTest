...
public class xLuaTest : MonoBehaviour {
    ...
    public interface ICalendar {
        int Day_Of_Week(int yy, int mm, int dd);
    ...
    public void TestEncryptionScript()
    {
        ...
        TextAsset encrypted = Resources.Load<TextAsset>("Encrypted.lua");

        byte[] luaBytes = _encryptionHelper.Decrypt(Convert.FromBase64String(encrypted.text), 102);
        string luaTxt = System.Text.Encoding.UTF8.GetString(luaBytes);
